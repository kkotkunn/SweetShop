...
{
    public partial class FormSClients : Form
    {
        [Dependency]
        public new IUnityContainer Container { get; set; }
        private readonly ISClientService service;
        public FormSClients(ISClientService service)
        {
            InitializeComponent();
            this.service = service;
        }
        private void FormSClients_Load(object sender, EventArgs e)
        {
            LoadData();
        }
        ...
        {
            var form = Container.Resolve<FormSClient>();
